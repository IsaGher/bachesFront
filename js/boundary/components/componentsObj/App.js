import ObjetoDataStore from '../../../control/ObjetoDataStore.js';

export default class App extends HTMLElement {
    constructor() {
      super();
      this.objeto = new ObjetoDataStore();
      this._data = [];
    ...
    handleSubmit(event) {
        this.objeto.modificar(event.detail);
        setTimeout(()=>{
            location.reload();
        },1500);
    }
    ...
    editCharacter(id) {
        let iD = Number(id);
        let valor = this._data.find(char => char.idObjeto === iD);
